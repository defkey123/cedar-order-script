...
extraS = 0
           ...
           time = str(now.year) + "," + str(now.month) + "," + str(now.day) + "," + str(now.hour) +","+ str(now.minute) +","+ str(orderNames)
           print(time)
           database.put("/Qn4DcOURt9NUPCqctVvnpADZJe83/log" ,time, [orderTTl,taxTotal])
